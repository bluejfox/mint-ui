...
<script type="text/babel">
  import picker from 'straw-ui/packages/picker/index.js';
  import popup from 'straw-ui/packages/popup/index.js';
  if (process.env.NODE_ENV === 'component') {
    require('straw-ui/packages/picker/style.css');
    require('straw-ui/packages/popup/style.css');
  }
